...
import { useBlogPageData, useData, useInternalLink, useTagColors } from '@theme/composables/index.js'
...
const price = computed(() => matter.value.price || '')
...
<template>
  <h1 class="vp-doc-title page-title" :class="{ padding: !hasMeta }">
    {{ page.title }}
    <VPBadge v-if="price" class="price-badge" type="tip" :text="price" />
